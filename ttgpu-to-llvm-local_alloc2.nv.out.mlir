module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 1 : i32, ttg.shared = 512 : i32} {
  ...
  llvm.func @local_alloc_ldmatrix(%arg0: !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>) attributes {nvvm.kernel = 1 : ui1, nvvm.reqntid = array<i32: 32>} {
    ...
    nvvm.barrier0
    %109 = llvm.extractvalue %108[0] : !llvm.struct<(ptr<3>, i32, i32)> 
    %110 = llvm.extractvalue %108[1] : !llvm.struct<(ptr<3>, i32, i32)> 
    %111 = llvm.extractvalue %108[2] : !llvm.struct<(ptr<3>, i32, i32)> 
    %112 = llvm.mlir.constant(0 : i32) : i32
    %113 = nvvm.read.ptx.sreg.tid.x : i32
    %114 = llvm.mlir.constant(31 : i32) : i32
    %115 = llvm.and %113, %114 : i32
    ...
    %122 = llvm.shl %115, %121 : i32
    %123 = llvm.or %120, %122 : i32
    %124 = llvm.mlir.constant(15 : i32) : i32
    %125 = llvm.and %123, %124 : i32
    %126 = llvm.mlir.constant(5 : i32) : i32
    %127 = llvm.shl %125, %126 : i32
    %128 = llvm.mlir.constant(0 : i32) : i32
    %129 = llvm.mlir.constant(16 : i32) : i32
    %130 = llvm.and %123, %129 : i32
    %131 = llvm.icmp "eq" %130, %128 : i32
    %132 = llvm.mlir.constant(16 : i32) : i32
    %133 = llvm.select %131, %128, %132 : i1, i32
    %134 = llvm.or disjoint %127, %133 : i32
    %135 = llvm.mlir.constant(0 : i32) : i32
    %136 = llvm.or disjoint %134, %135 : i32
    %137 = llvm.xor %119, %136 : i32
    %138 = llvm.mlir.constant(2 : i32) : i32
    %139 = llvm.mul %112, %138 : i32
    %140 = llvm.xor %137, %139 : i32
    %141 = llvm.mlir.constant(0 : i32) : i32
    %142 = llvm.xor %140, %141 : i32
    %143 = llvm.mlir.constant(0 : i32) : i32
    %144 = llvm.add %142, %143 : i32
    %145 = llvm.getelementptr inbounds %109[%144] : (!llvm.ptr<3>, i32) -> !llvm.ptr<3>, i8
    %146 = nvvm.ldmatrix %145 {eltType = #nvvm.ld_st_matrix_elt_type<b16>, layout = #nvvm.mma_layout<row>, num = 4 : i32, shape = #nvvm.ld_st_matrix_shape<m = 8, n = 8>} : (!llvm.ptr<3>) -> !llvm.struct<(i32, i32, i32, i32)>
    %147 = llvm.extractvalue %146[0] : !llvm.struct<(i32, i32, i32, i32)> 
    %148 = llvm.bitcast %147 : i32 to vector<2xf16>
    %149 = llvm.mlir.constant(0 : i32) : i32
    %150 = llvm.extractelement %148[%149 : i32] : vector<2xf16>
    %151 = llvm.mlir.constant(1 : i32) : i32
    %152 = llvm.extractelement %148[%151 : i32] : vector<2xf16>
    %153 = llvm.extractvalue %146[1] : !llvm.struct<(i32, i32, i32, i32)> 
    %154 = llvm.bitcast %153 : i32 to vector<2xf16>
    %155 = llvm.mlir.constant(0 : i32) : i32
    %156 = llvm.extractelement %154[%155 : i32] : vector<2xf16>
    %157 = llvm.mlir.constant(1 : i32) : i32
    %158 = llvm.extractelement %154[%157 : i32] : vector<2xf16>
    %159 = llvm.extractvalue %146[2] : !llvm.struct<(i32, i32, i32, i32)> 
    %160 = llvm.bitcast %159 : i32 to vector<2xf16>
    %161 = llvm.mlir.constant(0 : i32) : i32
    %162 = llvm.extractelement %160[%161 : i32] : vector<2xf16>
    %163 = llvm.mlir.constant(1 : i32) : i32
    %164 = llvm.extractelement %160[%163 : i32] : vector<2xf16>
    %165 = llvm.extractvalue %146[3] : !llvm.struct<(i32, i32, i32, i32)> 
    ...
    %171 = llvm.mlir.undef : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)>
    %172 = llvm.insertvalue %150, %171[0] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %173 = llvm.insertvalue %152, %172[1] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %174 = llvm.insertvalue %156, %173[2] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %175 = llvm.insertvalue %158, %174[3] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %176 = llvm.insertvalue %162, %175[4] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %177 = llvm.insertvalue %164, %176[5] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %178 = llvm.insertvalue %168, %177[6] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    %179 = llvm.insertvalue %170, %178[7] : !llvm.struct<(f16, f16, f16, f16, f16, f16, f16, f16)> 
    llvm.return
  }
}
